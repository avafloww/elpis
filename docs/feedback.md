...
Capture and retraction remain active whether or not bot-authored feedback controls are displayed. Feedback does not edit prompts, identity, memory, or conversation history. It is evidence for later review, not an automatic reward loop.
