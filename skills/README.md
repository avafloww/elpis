...
Inhabitant-authored skills belong in `elpis-data/config/skills/`, not here. Elpis deliberately does not discover `.agents/skills` or walk ancestor directories for skills.
