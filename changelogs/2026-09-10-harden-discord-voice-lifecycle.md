...
There is no configuration or migration change. The public Realtime bridge remains disabled by default and live provider and Discord-call acceptance are still required before deployment.
